...
ntheta = 181              # Solo 1 punto en theta
r = np.linspace(10*wl, 10*wl, nr)
...
q = np.linspace(0.25, 0.60, m_points)

n1 = np.linspace(2, 4, n_points)
for qi in q:
    for ni in n1: 
...
#            print(f"Procesando orden l={l}")
    ...
    print(f"Eficiencia Scattering (con campos): {Q_sca_poynting}")
#%%
c_sca_sum = 0.0
